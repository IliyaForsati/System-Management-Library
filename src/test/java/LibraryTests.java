...
class LibraryTests {
    ...
    void deleteAllWithSave() {
        List<Book1> bookList = library.getBooks();
    ...
    void addBookTest(String b, String author, int year, String status) {
        ...
        boolean isPass = bookList.size() > 0 && bookList.get(bookList.size() - 1).equals(
                new Book1(b, author, Year.of(year), Status.valueOf(status)));
        assertTrue(isPass);
    }
    ...
    void addBookWithSaveTest(String title, String author, int year, String status) {
        ...
        List<Book1> bookList = library.getBooks();
        Book1 lastBook = bookList.get(bookList.size() - 1);

        String[] args = lastLine.split(",");
        Book1 lastInFile = new Book1(args[0], args[1], Year.parse(args[2]), Status.valueOf(args[3]));
    ...
    void deleteBookTest(String title, String author, int year, String status) {
        ...
        boolean isPass = bookList.size() == 0 || !bookList.get(bookList.size() - 1).equals(
                new Book1(title, author, Year.of(year), Status.valueOf(status)));
        assertTrue(isPass);
    }
    ...
    void updateBookTest(String dist_title, String title, String author, int year, String status) {
        ...
        library.updateBook(dist_title, new Book1(title, author, Year.of(year), Status.valueOf(status)));
